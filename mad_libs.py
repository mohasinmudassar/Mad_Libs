# mad lists random story generator
...
# create a local _ dictionary to lookup words by type
...
#counting and deleting the words from local dictionary :
...
#Creating the story and defining the story format
